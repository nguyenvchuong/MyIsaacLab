...
from isaaclab_assets.robots.agility import ARM_JOINT_NAMES, DIGIT_V3_CFG, LEG_JOINT_NAMES
...
class DigitRoughEnvCfg(LocomotionVelocityRoughEnvCfg):
    ...
    def __post_init__(self):
        ...
        # Commands - Set to zero for stepping in place
        self.commands.base_velocity.ranges.lin_vel_x = (0.0, 0.0)
        self.commands.base_velocity.ranges.lin_vel_y = (0.0, 0.0)
        self.commands.base_velocity.ranges.ang_vel_z = (0.0, 0.0)
        self.commands.base_velocity.rel_standing_envs = 1.0  # All environments standing still
